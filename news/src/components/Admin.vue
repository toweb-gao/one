        ...
        <el-row>
          ...
          <el-col :span="6">
            <div style="margin-top:60px;">
              <i class="el-icon-user" style="color:white;">欢迎管理员!{{uname}}</i>
              <router-link to="/">
                <el-button
                  type="primary"
                  icon="el-icon-delete"
...
import Admin1 from "./Admin1.vue";
import Admin2 from "./Admin2.vue";
import Admin3 from "./Admin3.vue";
import Admin4 from "./Admin4.vue";
